...
export function AtlasMaps({ active = 'landscape' }: { active?: 'landscape' | 'workday' | 'servicenow' | 'earth' | 'technology' | 'decisions' | 'categories' }) {
  const ecosystemActive = active === 'workday' || active === 'servicenow';
