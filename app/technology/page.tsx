...
export default function Page() { return <Suspense fallback={<DestinationLoading active="technology" title="Slow foundations. Sudden breakthroughs."/>}><TechnologyView /></Suspense>; }
