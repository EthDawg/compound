  ...
  return (
    <div className="min-h-screen bg-ink text-white">
      <header className="mx-auto flex max-w-[1080px] items-center justify-between px-6 py-5">
        ...
        <Link href="/app" className="inline-flex h-8 items-center gap-1.5 rounded-md bg-white/10 px-3 text-[12.5px] font-medium hover:bg-white/15">
          Skip to the app <I.IArrow className="h-3 w-3" />
        </Link>
      </header>
