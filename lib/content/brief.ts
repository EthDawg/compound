...
export const LENSES: Lens[] = [
  {
    ...
    steps: [
      { n: 1, title: "Change one field, watch six systems move", mins: 2, href: "/companies/rippling/app", cta: "Open the app",
      ...
      { n: 2, title: "Hire someone in a jurisdiction you are not registered in", mins: 2, href: "/companies/rippling/app/hire", cta: "Try the hire flow",
      ...
      { n: 3, title: "The employee record everything hangs off", mins: 2, href: "/companies/rippling/app/people/e-009", cta: "Open a record",
      ...
      { n: 4, title: "Ask a question no single vendor can answer", mins: 2, href: "/companies/rippling/app/graph", cta: "Run a query",
      ...
      { n: 5, title: "The three deals we lose on purpose", mins: 3, href: "/companies/rippling/backstage/manual/where-we-lose-on-purpose", cta: "Read where it fails",
  ...
  },
  {
    ...
    steps: [
      { n: 1, title: "The falsifier, stated before it was needed", mins: 3, href: "/companies/rippling/backstage/metrics", cta: "See the scorecard",
      ...
      { n: 2, title: "The arithmetic of the second product", mins: 3, href: "/companies/rippling/backstage/manual/the-second-product", cta: "Read the economics",
      ...
      { n: 3, title: "The trough, described honestly", mins: 3, href: "/companies/rippling/backstage/manual/the-j-curve", cta: "Read the J-curve",
      ...
      { n: 4, title: "Fourteen decisions with their price tags", mins: 3, href: "/companies/rippling/backstage/decisions", cta: "Read the log",
      ...
      { n: 5, title: "Where the next decade of growth comes from", mins: 2, href: "/companies/rippling/backstage/trajectory", cta: "See the vectors",
  ...
  },
  {
    ...
    steps: [
      { n: 1, title: "The one rule everything else follows from", mins: 3, href: "/companies/rippling/backstage/manual/the-employee-is-the-schema", cta: "Read the constraint",
      ...
      { n: 2, title: "Why you will sometimes be blocked", mins: 2, href: "/companies/rippling/backstage/org", cta: "See the structure",
      ...
      { n: 3, title: "The nine skills that actually get people promoted here", mins: 4, href: "/companies/rippling/backstage/skills", cta: "Read the skills",
      ...
      { n: 4, title: "What we argue about and how it gets settled", mins: 2, href: "/companies/rippling/backstage/heresies", cta: "Read the heresies",
      ...
      { n: 5, title: "The nine years you missed", mins: 2, href: "/companies/rippling/backstage/timeline", cta: "Speed-run the history",
  ...
  },
  {
    ...
    steps: [
      { n: 1, title: "Isn't this just a conglomerate?", mins: 2, href: "/companies/rippling/backstage/ask", cta: "Start at question one",
      ...
      { n: 2, title: "The conditions under which this fails", mins: 3, href: "/companies/rippling/backstage/manual/when-not-to-do-this", cta: "Read the counter-case",
      ...
      { n: 3, title: "Where it loses, and which loss is not fine", mins: 3, href: "/companies/rippling/backstage/manual/where-we-lose-on-purpose", cta: "Read the loss column",
      ...
      { n: 4, title: "The metrics that would prove it wrong", mins: 2, href: "/companies/rippling/backstage/metrics", cta: "Check the falsifiers",
      ...
      { n: 6, title: "The AI claim, stated narrowly enough to be wrong", mins: 2, href: "/companies/rippling/backstage/agentic", cta: "Test the agentic case",
