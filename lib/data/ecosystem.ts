...
export const COMPANIES: Company[] = [
  ...
  C("employment-hero", "Employment Hero", "Compound platform", "Australia · NZ · UK · SEA · Canada",
    "Combine payroll machinery, operating expertise and a worker network to run more of employment for smaller businesses.",
    [14, 30, 62], [28, 72, 30], [58, 72, 48], [62, 74, 56],
    {
      strategic: "KeyPay brought the engine and partner channel; Employment Innovations brought operators; the worker network adds a distinct distribution loop.",
      installed: "Recurring payroll and HR relationships underpin the proposition. Humi expands Canadian reach while remaining a separately supported product path.",
      agentic: "The current ambition is employment execution through agents and services. The hard test is exception quality, not a count of automated tasks.",
      durability: "Payroll depth, operating expertise and worker trust can reinforce one another; product and responsibility boundaries must remain clear.",
    }, true, "2026-09", "fast"),
  ...
  C("elmo", "ELMO Software", "Regional entrenched", "Australia · NZ; wider UK group",
    "Connect learning, capability and reward decisions as an established ANZ HR suite becomes a workforce intelligence platform.",
    [46, 62, 30], [20, 74, 20], [38, 49, 28], [72, 22, 34], {
      strategic: "The Lyons-era 2026 repositioning makes connected workforce decisions the promise; acquired HR depth gives it substance and integration work.",
      installed: "ANZ mid-market HR is the product's centre of gravity. Breathe and Rotageek are distinct group businesses, not universal ELMO modules.",
      agentic: "Live Insights and interface modernisation sit beside announced capability work. The score reflects a developing position, not proven autonomous execution.",
      durability: "Learning, performance and remuneration context can deepen usage if managers can act on it together. Payroll remains an explicit provider boundary.",
    }, true, "2026-09", "fast"),

  C("pageup", "PageUp", "Point specialist", "Australia · global; European ATS",
    "Own complex hiring workflows and candidate relationships, then make their context useful through evidence-backed assistance.",
    [55, 48, 38], [26, 76, 31], [48, 62, 38], [70, 43, 42], {
      strategic: "Clinch, eArcu and PathMotion extend the hiring journey. EQT and Eric Lochner's current chapter emphasises coherence, global reach and AI.",
      installed: "Configurable hiring fits institutions with committees and approvals; Clinch can also complement an incumbent ATS.",
      agentic: "Paige's June 2026 release offers citation-backed hiring context. Reviewer control and missing evidence remain the test.",
      durability: "Process fit and reusable candidate relationships can create durable depth without ownership of the whole HR record.",
    }, true, "2026-09", "fast"),
...
export const ADJACENT: Company[] = [
  ...
  C("accenture", "Accenture", "Integrator channel", "Global",
    "Join strategy, technology and managed operations around a client's business change; make AI a delivery method as well as a sale.",
    [52, 92, 62], [88, 82, 74], [40, 66, 48], [86, 62, 76],
    {
      strategic: "Reinvention Services brings advisory, technology and operations together under Manish Sharma. The 2026 reorganisation is a bet on integrated outcomes; organisational design alone does not prove them.",
      installed: "Consulting and managed services each contributed about half of Q3 FY26 revenue. The relationship spans building systems and running them, with different switching costs and economics.",
      agentic: "Automation can reduce delivery effort and support new managed services. Who captures the gain depends on scope, pricing and verified outcomes.",
      durability: "Relationships, process knowledge and operating responsibility can endure as work changes. Ask which obligations remain when fewer delivery hours are needed.",
    }, true, "2026-09", "medium"),
  C("deloitte", "Deloitte", "Integrator channel", "Global",
    "Let advisory shape the programme, then combine industry knowledge, platform implementation and model engineering to deliver it.",
    [54, 90, 50], [82, 78, 62], [38, 62, 40], [84, 56, 64], {
      strategic: "The September 2026 Open Model Engineering launch broadens the AI proposition. Validate the people and production experience available in the contracting member firm.",
      installed: "A shared brand connects separate member firms. Network reach and a local team's accountable capacity are different things.",
    }, false, "2026-09", "medium"),
  C("infosys", "Infosys", "Integrator channel", "India · global",
    "Turn global delivery into repeatable AI-enabled services, combining Topaz Fabric with industry expertise such as Optimum Healthcare IT.",
    [58, 84, 42], [76, 74, 54], [34, 56, 34], [78, 48, 54], {
      strategic: "Optimum Healthcare IT adds provider-side healthcare capability; acquisitions can open a new buying centre as well as add people.",
      agentic: "Topaz Fabric packages AI components into service delivery. The useful test is reliable completion in the client's environment, not the number of agents announced.",
    }, false, "2026-09", "medium"),
...
export const EDGES: Edge[] = [
  ...
  { from: "employment-hero", to: "elmo", kind: "competes", note: "Employment execution and worker distribution meet an HR-centred capability and talent suite." },
  { from: "employment-hero", to: "rippling", kind: "competes", note: "Overlapping employment workflows, different centres of gravity: payroll/services/network versus employee-data orchestration." },
  { from: "pageup", to: "workday", kind: "powers", note: "Clinch's Workday integration adds recruitment marketing alongside the incumbent ATS; it is a partnership, not ownership." },
